...
function FishDrag(props) {
    const {piece, width, height} = props;

    return( 
        <Draggable>
        <div className="drag-container-main">
            <img className="piece-content" src={piece} width={width} height={height} alt="i draw this"/>
            <svg className="piece-bg" width={width+60} height={height+180} viewBox='0 0 533 407' fill="none" xmlns="http://www.w3.org/2000/svg">
