    ...
    <div className="creative-container">
      <div className="project-container-secondary">
        <div id="illustration-desc">
          ...
          <em>2019-Present</em>
          <p>
            Over the past year I&#39;ve been teaching myself to draw, here are a few examples meant to illustrate that
            progress. <b>Feel free to click and drag around the images.</b>
          </p>
        </div>
        <Pieces />
      </div>
      ...
      <div className="artist-desc">
        <h2>An Artist</h2>
        <p>
          Art is my exploration of my varying interests - whether it&#39;s acting & improv, illustration, music,
          computer programming, etc. My fine art is mostly self-taught, the focus of my work being to express with
          honesty, in whatever the best form I feel is suited for and reflects the work itself.
        </p>
      </div>
      <br />
      <br />
      <div className="project-container-tertiary">
        <div className="desc-container" id="video-desc">
          ...
          <em>2016-2020</em>
          <p id="reel-text">
            I&#39;m also a passionate video editor and actor, and have been involved in a number of student films
            through my <a href="https://www.facebook.com/jericho.comedy">improv team</a>,
            <a href="https://www.giantfilmmakersucb.org/"> GiANT Filmmakers</a>, and{" "}
            <a href="http://caldka.org/">Cal DKA</a>.
          </p>
        </div>
        <div>
          <iframe
            src="https://player.vimeo.com/video/346242259"
            width="640"
            height="360"
            frameBorder="0"
...
function Pieces() {
  ...
  const buildOrder = (n) => {
    var temp = {
      fish: orderObj.fish,
      sleep: orderObj.sleep,
      hand: orderObj.hand,
      aliens: orderObj.aliens,
      couch: orderObj.couch,
      places: orderObj.places,
    };
    temp[n] = maxHeight;
    return temp;
  };
